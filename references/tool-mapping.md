...
## 0. 事实来源（Single Source of Truth）

- Tool 全量清单、入参/出参与字段口径的权威说明：`/data/obsidian-vault/DMP/MCP_Tools_Spec_2026-04-25.md`
- 本文件用于“执行层路由与易错点提示”。当与权威文档不一致时，应先以权威文档为准并回填修正。
